...
class PNTest extends FunSpec {
  ...
  describe("Integer subtract function") {
    it("should subtract two lists with arbitraty length correctly for base 2") {
      ...
      assert((num1 - (num2, 2)) equals PN( result))
    ...
    it("should subtract two lists with arbitraty length correctly for base 8") {
      ...
      assert((num1 - (num2, 8)) equals PN( result))
    ...
    it("should subtract two lists with arbitraty length correctly for base 10") {
      ...
      assert((num1 - num2) equals PN( List(1, 1, 3, 6)))
    ...
    it("should subtract two lists with arbitraty length correctly for base 16") {
      ...
      assert((num1 - (num2, 16)) equals PN( result))
    ...
    it("should add two lists with arbitraty length correctly for mixed base (24, 60)") {
      ...
      assert((num1 - (num2, List(24, 60))) equals PN( result))
      assert((num1 subtractWithSign (num2, List(24,60)))._2 )
    ...
    it("if result is negative, it should be represented in b's complement"){
      ...
      val num2 = List(3,2,9)
      assert((num1 - num2) equals PN( List(8,5,6)))
      assert(!(num1 subtractWithSign num2)._2 )
    }
  }
  ...
  describe("Integer longDiv function"){
    it("should return (1,remainder) when quotient is 1"){
      val num1 = List(1, 9, 8)
      val num2 = List(1, 9, 5)
      assert((num1 / (num2, 10)) equals PN( List(1)) )
      assert((num1 % (num2, 10)) equals PN( List(3)))
    }

    it("should divide two lists for base 2"){
      val num1 = List(1, 1, 1, 0, 1)
      val num2 = List(1, 0, 1)
      assert(num1 / (num2,2) equals  PN(List(1,0,1)))
      assert((num1 % (num2,2)) equals PN( List(1,0,0)))
    ...
    it("should divide two lists for base 10 when v is only one digit"){
      val num1 = List(7, 8, 9)
      val num2 = List(9)
      assert((num1 / (num2,10)) equals  PN( List(8, 7)))
    ...
    it("should divide two lists for base 10"){
      val num1 = List(7, 8, 9)
      val num2 = List(9, 8)
      assert((num1 / (num2, 10)) equals PN( List(8)) )
      assert((num1 % (num2, 10)) equals PN( List(5)))
    ...
    it("should return (0, 0) if divisee is 0"){
      val num1 = List(0)
      val num2 = List(9, 8)
      assert((num1 / (num2, 10)) equals PN( List(0)) )
      assert((num1 % (num2, 10)) equals PN( List(0)))
    }
    ...
    it("should return (0, divisee) if divisee is less than divisor"){
      ...
      val num2 = List(9, 8)
      assert((num1 / (num2, 10)) equals PN( List(0)) )
      assert((num1 % (num2, 10)) equals PN( List(7,8)))
    }
