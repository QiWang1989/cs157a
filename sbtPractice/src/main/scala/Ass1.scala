...
//    println("longDiv (base 10): " + longDiv(789, 98, 10).get) //101...100
  //    println("subtract (base 10): " + subtract(185, 185)) //List(5, 23, 1)
  //    println("subtract (base 10): " + subtract(392, 185)) //List(5, 23, 1)
